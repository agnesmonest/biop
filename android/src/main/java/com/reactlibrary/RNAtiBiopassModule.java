...
public class RNAtiBiopassModule extends ReactContextBaseJavaModule {
  private static final String KEYCHAIN_DATA = "RN_ATIBIOPASS";
  private static final String DEFAULT_SERVICE = "RN_ATIBIOPASS_DEFAULT_ALIAS";
  ...
  public RNAtiBiopassModule(ReactApplicationContext reactContext) {
    super(reactContext);
